...
var Windy = function( params ){
  ...
  var interpolateField = function( grid, bounds, extent, callback ) {
    ...
    var gradient = segmentedColorScale([
      [193,     [37, 4, 42]],
      [206,     [41, 10, 130]],
      [219,     [81, 40, 40]],
  ...
  var segmentedColorScale = function(segments) {
  ...
  var setColor = function(x, y, rgba) {
    var i = (y * windy.width + x) * 4;
    windy.imageData.data[i    ] = rgba[0];
    windy.imageData.data[i + 1] = rgba[1];
    windy.imageData.data[i + 2] = rgba[2];
    windy.imageData.data[i + 3] = rgba[3];
  };
  ...
  var start = function( bounds, width, height, extent, callback ){
